...
(function() {
    ...
    function rubricMark() {
        ...
        var rubricPanel = tokenReceiver.shadowRoot.querySelector('d2l-consistent-evaluation-page').shadowRoot.querySelector('d2l-template-primary-secondary').querySelector('consistent-evaluation-right-panel').shadowRoot.querySelector('d2l-consistent-evaluation-rubric').shadowRoot.querySelector('d2l-consistent-evaluation-right-panel-block').querySelector('d2l-rubric').shadowRoot.querySelector('d2l-rubric-adapter').shadowRoot.querySelector('d2l-labs-accordion-collapse').shadowRoot.querySelector('#trigger');
        console.log(rubricPanel);
        rubricPanel.click();
